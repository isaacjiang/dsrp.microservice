...
//    }
    ...
    public Optional<GridFsResource> getFileAsResource1(final String id) {
    ...
    public GridFsResource getFileAsResource(final String id) {
        return gridFsTemplate.getResource(getFileById(id));
    }
